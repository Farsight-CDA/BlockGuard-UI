	...
	<div class="w-full h-full items-center justify-center flex flex-col">
		...
		>
			...
			<div class="flex flex-col gap-8 p-4 rounded-lg">
				<button
					class="bg-green-600 p-3 hover:bg-green-500 drop-shadow-glow-green-400 rounded-md border-2 border-neutral-800"
					on:click={handleCreateWallet}
					>Create Wallet <br /> (Recommended)</button
				>
				<button
					class="bg-blue-600 hover:bg-blue-500 p-3 shadow-lg drop-shadow-glow-blue-400 rounded-md border-2 border-neutral-800"
